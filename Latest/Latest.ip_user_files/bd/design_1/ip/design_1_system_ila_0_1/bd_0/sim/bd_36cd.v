...
module bd_36cd
   (SLOT_0_AXI_araddr,
    ...
    probe8,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 1, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, DATA_WIDTH 128, FREQ_HZ 299970032, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 16, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 16" *) input [31:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI RUSER" *) input [15:0]SLOT_0_AXI_ruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 299970032, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [255:0]probe0;
  input [31:0]probe1;
  input [0:0]probe2;
  input [0:0]probe3;
  ...
  wire [15:0]net_slot_0_axi_ruser;
  ...
  assign Conn_RUSER = SLOT_0_AXI_ruser[15:0];
  ...
  bd_36cd_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe11(net_slot_0_axi_arcache),
        .probe12(net_slot_0_axi_arid),
        .probe13(net_slot_0_axi_arlen),
        .probe14(net_slot_0_axi_arlock),
        .probe15(net_slot_0_axi_arprot),
        .probe16(net_slot_0_axi_arqos),
        .probe17(net_slot_0_axi_arsize),
        .probe18(net_slot_0_axi_aruser),
        .probe19(net_slot_0_axi_awid),
        .probe2(probe2_1),
        .probe20(net_slot_0_axi_awuser),
        .probe21(net_slot_0_axi_bid),
        .probe22(net_slot_0_axi_rdata),
        .probe23(net_slot_0_axi_rid),
        .probe24(net_slot_0_axi_rresp),
        .probe25(net_slot_0_axi_ruser),
