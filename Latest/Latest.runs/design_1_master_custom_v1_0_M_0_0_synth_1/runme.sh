...
HD_PWD='C:/larry_delivery/Latest/Latest.runs/design_1_master_custom_v1_0_M_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_master_custom_v1_0_M_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_master_custom_v1_0_M_0_0.tcl
