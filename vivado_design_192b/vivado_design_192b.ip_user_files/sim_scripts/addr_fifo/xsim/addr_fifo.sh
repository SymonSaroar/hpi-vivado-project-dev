...
#
# Script generated by Vivado on Thu Jun 20 13:59:18 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : addr_fifo.sh
...
#
# Usage        : addr_fifo.sh
#                addr_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                addr_fifo.sh [-reset_run]
#                addr_fifo.sh [-reset_log]
#                addr_fifo.sh [-help]
#
...
# script info
echo -e "addr_fifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./addr_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot addr_fifo xil_defaultlib.addr_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim addr_fifo -key {Behavioral:sim_1:Functional:addr_fifo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b3b8.protoinst" -protoinst "protoinst_files/design_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb addr_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./addr_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: addr_fifo.sh [-help]\n\
Usage: addr_fifo.sh [-step]\n\
Usage: addr_fifo.sh [-lib_map_path]\n\
Usage: addr_fifo.sh [-reset_run]\n\
Usage: addr_fifo.sh [-reset_log]\n\
Usage: addr_fifo.sh [-keep_index]\n\
Usage: addr_fifo.sh [-noclean_files]\n\n\
