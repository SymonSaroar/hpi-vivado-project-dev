...
design_libs=(xilinx_vip xpm lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xlconstant_v1_1_7 smartconnect_v1_0 axi_register_slice_v2_1_28 generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_protocol_converter_v2_1_28)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/symon/hpi-dev/hpi-vivado-project-dev/vivado_design_192b/vivado_design_192b.cache/compile_simlib/vcs"
  fi
