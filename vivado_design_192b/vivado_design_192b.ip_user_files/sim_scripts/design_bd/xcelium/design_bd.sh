...
#
# Script generated by Vivado on Thu Jun 20 13:55:43 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_bd.sh
...
#
# Usage        : design_bd.sh
#                design_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_bd.sh [-reset_run]
#                design_bd.sh [-reset_log]
#                design_bd.sh [-help]
#
...
#                script (type 'design_bd.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname zynq_ultra_ps_e_vip_v1_0_15 -libname xil_defaultlib -libname xlconstant_v1_1_8 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_29 -libname generic_baseblocks_v2_1_1 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_protocol_converter_v2_1_29 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 zynq_ultra_ps_e_vip_v1_0_15 xil_defaultlib xlconstant_v1_1_8 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 smartconnect_v1_0 axi_register_slice_v2_1_29 generic_baseblocks_v2_1_1 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_protocol_converter_v2_1_29)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design_bd.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../../Design_src/bd/design_bd/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work zynq_ultra_ps_e_vip_v1_0_15 $xmvlog_opts -sv +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/design_bd/ip/design_bd_zynq_ultra_ps_e_0_0/sim/design_bd_zynq_ultra_ps_e_0_0_vip_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../../Design_src/bd/design_bd/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../../Design_src/bd/design_bd/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../../Design_src/bd/design_bd/ipshared/ec67/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/2fcd/hdl" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/f0b6/hdl/verilog" +incdir+"../../../../../Design_src/bd/design_bd/ipshared/35de/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_bd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_bd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_bd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_bd.sh [-help]\n\
Usage: design_bd.sh [-step]\n\
Usage: design_bd.sh [-lib_map_path]\n\
Usage: design_bd.sh [-reset_run]\n\
Usage: design_bd.sh [-reset_log]\n\
Usage: design_bd.sh [-keep_index]\n\
Usage: design_bd.sh [-noclean_files]\n\n\
