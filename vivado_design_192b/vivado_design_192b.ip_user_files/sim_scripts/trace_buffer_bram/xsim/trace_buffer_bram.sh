...
#
# Script generated by Vivado on Thu Jun 20 13:59:03 -0700 2024
...
# script info
echo -e "trace_buffer_bram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot trace_buffer_bram xil_defaultlib.trace_buffer_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim trace_buffer_bram -key {Behavioral:sim_1:Functional:trace_buffer_bram} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b3b8.protoinst" -protoinst "protoinst_files/design_bd.protoinst" -log simulate.log
}
