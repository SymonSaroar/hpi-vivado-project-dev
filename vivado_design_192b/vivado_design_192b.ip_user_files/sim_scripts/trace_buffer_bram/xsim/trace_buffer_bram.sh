...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_14 -L zynq_ultra_ps_e_vip_v1_0_14 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot trace_buffer_bram xil_defaultlib.trace_buffer_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim trace_buffer_bram -key {Behavioral:sim_1:Functional:trace_buffer_bram} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_adc0.protoinst" -protoinst "protoinst_files/design_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb trace_buffer_bram.wdb xsim.dir libdpi.so)
