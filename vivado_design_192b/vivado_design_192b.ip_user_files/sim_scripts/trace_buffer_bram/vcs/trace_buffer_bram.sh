...
#
# Script generated by Vivado on Wed Jun 05 17:01:22 +06 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : trace_buffer_bram.sh
...
#
# Usage        : trace_buffer_bram.sh
#                trace_buffer_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                trace_buffer_bram.sh [-reset_run]
#                trace_buffer_bram.sh [-reset_log]
#                trace_buffer_bram.sh [-help]
#
...
#                script (type 'trace_buffer_bram.sh -help' for more information).
#
...
# script info
echo -e "trace_buffer_bram.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./trace_buffer_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.trace_buffer_bram xil_defaultlib.glbl -o trace_buffer_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./trace_buffer_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key trace_buffer_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc trace_buffer_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./trace_buffer_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: trace_buffer_bram.sh [-help]\n\
Usage: trace_buffer_bram.sh [-step]\n\
Usage: trace_buffer_bram.sh [-lib_map_path]\n\
Usage: trace_buffer_bram.sh [-reset_run]\n\
Usage: trace_buffer_bram.sh [-reset_log]\n\
Usage: trace_buffer_bram.sh [-keep_index]\n\
Usage: trace_buffer_bram.sh [-noclean_files]\n\n\
