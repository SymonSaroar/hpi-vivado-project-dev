...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "add_val"
  ipgui::add_param $IPINST -name "cache_value"
  ipgui::add_param $IPINST -name "axi_prot"
...
proc update_PARAM_VALUE.axi_prot { PARAM_VALUE.axi_prot } {
	# Procedure called to update axi_prot when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.axi_prot { PARAM_VALUE.axi_prot } {
	# Procedure called to validate axi_prot
	return true
}

proc update_PARAM_VALUE.cache_value { PARAM_VALUE.cache_value } {
	# Procedure called to update cache_value when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cache_value { PARAM_VALUE.cache_value } {
	# Procedure called to validate cache_value
	return true
}
...
proc update_MODELPARAM_VALUE.cache_value { MODELPARAM_VALUE.cache_value PARAM_VALUE.cache_value } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cache_value}] ${MODELPARAM_VALUE.cache_value}
}

proc update_MODELPARAM_VALUE.axi_prot { MODELPARAM_VALUE.axi_prot PARAM_VALUE.axi_prot } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.axi_prot}] ${MODELPARAM_VALUE.axi_prot}
}
